# 💪 TEAM 으라차차 "아차차(achacha)"

## 🏆SSAFY 12기 자율프로젝트 우수상🏆

<img src="https://github.com/user-attachments/assets/219710ef-b3e7-4ec9-bd73-cbc011725893" width="150"/>
...
- OCR + LangChain
    ...
    ![스크린샷 2025-06-11 오후 12.17.53.png](attachment:d2eb09d5-0fbf-4ef5-97b8-d72f40245294:스크린샷_2025-06-11_오후_12.17.53.png)
    ...
    **기프티콘 등록 자동화를 위한 지능형 텍스트 인식 및 분류 시스템**
    ...
    - **LangChain + GPT**: 추출된 텍스트를 프롬프트 엔지니어링을 통해 브랜드, 바코드, 상품명, 유효기간 등으로 자동 분류
    - **사용자 경험**: 별도 입력 없이 이미지만으로 간편한 기프티콘 등록 가능
- Geofencing
    
    ![스크린샷 2025-06-11 오후 12.18.07.png](attachment:30ca579d-0ac9-4b8b-89e4-d53653ba0bd4:스크린샷_2025-06-11_오후_12.18.07.png)
    ...
    **위치 기반 스마트 알림을 위한 가상 경계 설정 기술**
    ...
    - **효율적인 위치 추적**: GPS 대비 낮은 배터리 소모량으로 지속적인 모니터링
    - **스마트 업데이트**: 사용자가 100m 이상 이동 시 주변 500m 반경 매장 재검색 및 지오펜스 재설정
    - **중복 알림 방지**: 브랜드별 알림 간격 제어 (포그라운드 30분, 백그라운드 2시간)
- BLE
    
    ![스크린샷 2025-06-11 오후 12.20.36.png](attachment:0853c2a4-cc5a-4b83-aeb0-09e5f6989af7:스크린샷_2025-06-11_오후_12.20.36.png)
    ...
    **근거리 기프티콘 공유를 위한 저전력 무선 통신 기술**
    ...
    - **효율적인 통신**: 반경 100m 이내에서 5초간 주변 사용자 탐색
    - **저전력 설계**: 블루투스 저전력 통신으로 배터리 부담 최소화
    - **백그라운드 제한**: 포그라운드에서만 작동하여 배터리 소모 최적화
- 알림 서버 분리
    
    ![image.png](attachment:31e9a90b-dacc-47af-aff0-286ed38ca0a4:image.png)
    ...
    **대용량 알림 처리를 위한 마이크로서비스 아키텍처**
    ...
    - **RabbitMQ 메시지 큐**: Push 기반 즉시 전달 방식으로 비동기 알림 처리
    - **성능 개선**: 동기 방식 대비 알림 전송 속도 2배 향상 (10초 → 4.8초)
    - **확장성**: 알림 서버 독립적 확장으로 향후 부하 분산 용이
...
<!-- 플랫폼 & 프레임워크 -->
<img src="https://img.shields.io/badge/react--native-61DAFB?style=for-the-badge&logo=react&logoColor=white"/><img src="https://img.shields.io/badge/expo-000020?style=for-the-badge&logo=expo&logoColor=white"/><img src="https://img.shields.io/badge/kotlin-7F52FF?style=for-the-badge&logo=kotlin&logoColor=white"/>
